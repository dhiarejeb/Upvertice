...
export function getTransactionById(http: HttpClient, rootUrl: string, params: GetTransactionById$Params, context?: HttpContext): Observable<StrictHttpResponse<SupplierTransactionResponse>> {
...
getTransactionById.PATH = '/supplier-transactions/{id}';
